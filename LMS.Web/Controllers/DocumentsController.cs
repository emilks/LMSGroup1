...
namespace LMS.Web.Controllers
{
    public class DocumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Timestamp,FilePath")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Timestamp,FilePath")] Document document)
        {
            if (id != document.Id)
            {
                return NotFound();
